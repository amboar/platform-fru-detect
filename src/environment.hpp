...
class ExecutionEnvironment
{
  public:
    ...
    virtual void run(PlatformManager& pm, Notifier& notifier, Inventory* inventory) = 0;
};
...
class SimicsExecutionEnvironment : public ExecutionEnvironment
{
  public:
    ...
    virtual void run(PlatformManager& pm, Notifier& notifier, Inventory* inventory) override;
};
