...
void EnvironmentManager::run(PlatformManager& pm, Notifier& notifier, Inventory* inventory)
{
...
void SimicsExecutionEnvironment::run(PlatformManager& pm, Notifier& notifier, Inventory* inventory)
{
